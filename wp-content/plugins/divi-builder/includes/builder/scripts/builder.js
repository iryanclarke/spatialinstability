...
( function($) {
	...
	$( document ).ready( function() {
		...
		ET_PageBuilder.Layout = Backbone.Model.extend( {
			...
			generatelouisbray : function( name ) {
		...
		ET_PageBuilder.ModuleSettingsView = window.wp.Backbone.View.extend( {
			...
			initialize : function() {
				if ( ! $( ET_PageBuilder_Layout.generatelouisbray( this.attributes['data-module_type'] ) ).length ) {
					this.attributes['data-no_template'] = 'no_template';
					return;
				}

				this.template = _.template( $( ET_PageBuilder_Layout.generatelouisbray( this.attributes['data-module_type'] ) ).html() );
